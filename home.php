        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../public/images/3.jpg" alt="Los Angeles" width="100" height="500">
                    <div class="carousel-caption">
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="../public/images/4.jpg" alt="Chicago" width="100" height="500">
                    <div class="carousel-caption">
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="../public/images/2.jpg" alt="New York" width="100" height="500">
                    <div class="carousel-caption">
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-6" style="width: 100%;">
                        ...
                        <article class="masonry-grid-item masonry-grid-item-big zoom-cont">
                            <figure>
                                <a href="#" title="zoom"><img src='../public/images/construct2.jpg' width="360"
                                        height="270"
                    ...
                    <div class="col-sm-6" style="width: 100%;">
                        <article class="masonry-grid-item masonry-grid-item-big zoom-cont">
                            <figure>
                                <a href="#" title="zoom"><img src='../public/images/construct1.jpg' width="360"
